...
def test_user2(client):
    user_data = {"email" : "nstnghfri95959951@gmail.com",
...
def test_user(client):
    user_data = {"email" : "nstnghfri9595995@gmail.com",
                    "password" : "password123"}
    res = client.post("/users/",json=user_data)
    assert res.status_code == 201
    print(res.json())
...
def test_posts(test_user,session,test_user2):
    ...
    #                  models.User(title="3nd title",content="3nd content",owner_id=test_user['id'])
    #                  ])
    session.commit()
